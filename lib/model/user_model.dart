class User {
  ...
  final String authType; // 인증 유형 (예: 'email', 'google', 'facebook' 등)
  ...
  factory User.fromMap(Map<String, dynamic> map) {
    return User(
      ...
      authType: map['authType'] ?? 'email', // 인증 유형 기본값 'email'
